...
public class AppointmentResourceIntTest {
    ...
    public void createAppointment() throws Exception {
        ...
        assertThat(testAppointment.getPlace()).isEqualTo(DEFAULT_PLACE);
        assertThat(testAppointment.getDate()).isEqualTo(DEFAULT_DATE);
        assertThat(testAppointment.getDuration()).isEqualTo(DEFAULT_DURATION);
    }
    ...
    public void updateAppointment() throws Exception {
        ...
        Appointment testAppointment = appointmentList.get(appointmentList.size() - 1);
        assertThat(testAppointment.getPlace()).isEqualTo(UPDATED_PLACE);
        assertThat(testAppointment.getDate()).isEqualTo(UPDATED_DATE);
        assertThat(testAppointment.getDuration()).isEqualTo(UPDATED_DURATION);
    }
